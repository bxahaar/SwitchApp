...
import {updateInspectionHistory, updateInsuranceHistory} from "../../../supabase/functions/server/insurance_inspection";
...
export const CarManagement: React.FC = () => {
    ...
    const handleSaveDates = async () => {
        ...
        try {
            if (type === 'insurance') {
                await updateInsuranceHistory(carId, {
                    startDate: dateFormData.startDate,
                    endDate: dateFormData.endDate,
                });
            } else {
                await updateInspectionHistory(carId, {
                    startDate: dateFormData.startDate,
                    endDate: dateFormData.endDate,
                });
            }
